...
public enum PotionList {
	...
	static {
		...
		DEBUFF.potList.add(PotionEffectType.NAUSEA);
		DEBUFF.potList.add(PotionEffectType.GLOWING);
		DEBUFF.potList.add(PotionEffectType.INSTANT_DAMAGE);
		...
		DEBUFF.potList.add(PotionEffectType.SLOWNESS);
		DEBUFF.potList.add(PotionEffectType.MINING_FATIGUE);
