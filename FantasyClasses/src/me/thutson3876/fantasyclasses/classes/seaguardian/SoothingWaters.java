...
public class SoothingWaters extends AbstractAbility implements Bindable {
	...
	public void onPlayerDropItemEvent(PlayerDropItemEvent e) {
		...
		if(!AbilityUtils.isInWaterOrRain(player))
			return;
		...
		Particles.helix(target, Particle.DOLPHIN, target.getWidth(), 2 * 6.3, 2, 0.1);
	...
	public String getDescription() {
		return "Grant your target (or yourself) a short burst of speed and regeneration &6" + (amp + 1) + " &rwhile in the water. When used on another target, healing is increased";
	}
