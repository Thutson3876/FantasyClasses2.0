...
public class RollToPort extends AbstractAbility {
	...
	public void setDefaults() {
		...
		this.displayName = "Roll To Port";
		this.skillPointCost = 1;
		this.maximumLevel = 2;

		this.createItemStack(Material.BIRCH_BOAT);
	}
	...
	public String getInstructions() {
		return "Consume a stack of &dBlindsided";
	}

	@Override
	public String getDescription() {
		return "When you consume a stack of &dBlindsided&r, you have a &6" + AbilityUtils.doubleRoundToXDecimals(chance * 100, 1)
