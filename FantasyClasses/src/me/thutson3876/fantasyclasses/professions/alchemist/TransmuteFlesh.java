...
public class TransmuteFlesh extends AbstractAbility {
	
	List<Material> transmutes = Arrays.asList(Material.ROTTEN_FLESH, Material.PHANTOM_MEMBRANE, Material.SPIDER_EYE, 
			Material.BONE, Material.BEEF, Material.CHICKEN, Material.MUTTON, Material.PORKCHOP, Material.LEATHER, Material.COD, Material.SALMON, Material.PUFFERFISH,
			Material.PUFFERFISH, Material.TROPICAL_FISH);
	
	public TransmuteFlesh(Player p) {
		super(p);
	}
	...
	public void setDefaults() {
		...
		this.displayName = "Transmute: Flesh";
		this.skillPointCost = 1;
		this.maximumLevel = 1;

		this.createItemStack(Material.ROTTEN_FLESH);
	}
	...
	public String getInstructions() {
		return "Mix two mob drops in a cauldron";
	}

	@Override
	public String getDescription() {
		return "Transmute the properties of one flesh into another. Toss two different stacks of mob drops into a cauldron and stir. The larger stack is converted into the same type as the smaller stack, at a price...";
	}
