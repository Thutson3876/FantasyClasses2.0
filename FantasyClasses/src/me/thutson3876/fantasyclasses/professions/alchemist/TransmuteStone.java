...
public class TransmuteStone extends AbstractAbility {
	
	List<Material> transmutes = MaterialLists.STONE.getMaterials();
	
	public TransmuteStone(Player p) {
		super(p);
	}
	...
	public void setDefaults() {
		...
		this.createItemStack(Material.DEEPSLATE);
	}
	...
	public String getInstructions() {
		return "Mix two naturally occuring stones in a cauldron";
	}

	@Override
	public String getDescription() {
		return "Transmute the properties of one stone into another. Toss two different stacks of stone into a cauldron and stir. The larger stack is converted into the same type as the smaller stack, at a price...";
	}
