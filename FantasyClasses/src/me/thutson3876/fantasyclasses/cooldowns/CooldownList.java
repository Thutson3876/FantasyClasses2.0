...
public class CooldownList extends LinkedList<CooldownContainer> {
	...
	public void add(Player player, Ability ability, double cooldown, double cooldownReductionPerTick) {
		remove(player, ability);
		add(new CooldownContainer(player, ability, cooldown, cooldownReductionPerTick));
	}
}
