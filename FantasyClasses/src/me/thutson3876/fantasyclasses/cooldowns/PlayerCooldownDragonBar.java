...
public class PlayerCooldownDragonBar {
	...
	public void tick() {
		...
		Map<Ability, Double> cooldowns = FantasyClasses.getPlugin().getCooldownManager().getAllCooldownsForPlayer(player);
		for (Map.Entry<Ability, Double> entry : cooldowns.entrySet()) {
